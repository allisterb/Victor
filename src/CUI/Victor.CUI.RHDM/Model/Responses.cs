...
namespace Victor.CUI.RHDM.KIE.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Responses :  IEquatable<Responses>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Responses" /> class.
        /// </summary>
        /// <param name="response">response.</param>
        public Responses(List<Response> response = default(List<Response>))
        {
        ...
        {
            return this.Equals(input as Responses);
        }

        /// <summary>
        /// Returns true if Responses instances are equal
        /// </summary>
        /// <param name="input">Instance of Responses to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Responses input)
        {
            if (input == null)
                return false;
