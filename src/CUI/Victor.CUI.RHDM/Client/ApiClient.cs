...
namespace Victor.CUI.RHDM.KIE.Client
{
    ...
    public partial class ApiClient
    {
        ...
        public ApiClient()
        {
            Configuration = Victor.CUI.RHDM.KIE.Client.Configuration.Default;
            RestClient = new RestClient("https://localhost/services/rest");
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="ApiClient" /> class
        /// with default base path (https://localhost/services/rest).
        /// </summary>
        ...
        public ApiClient(String basePath = "https://localhost/services/rest")
        {
