...
namespace Victor.CUI.RHDM.KIE.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        {
            UserAgent = "Swagger-Codegen/0.1/csharp";
            BasePath = "https://localhost/services/rest";
        ...
        public Configuration(
            ...
            string basePath = "https://localhost/services/rest") : this()
        {
        ...
        public Configuration(
            ...
            int timeout = 100000,
            string userAgent = "Swagger-Codegen/0.1/csharp"
        ...
        {
            String report = "C# SDK (Victor.CUI.RHDM.KIE) Debug Report:\n";
            report += "    OS: " + System.Environment.OSVersion + "\n";
            report += "    .NET Framework Version: " + System.Environment.Version  + "\n";
            report += "    Version of the API: 7.0\n";
            report += "    SDK Package Version: 0.1\n";
